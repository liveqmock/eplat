...
public class AdvancedMedia extends Application {
    ...
    public class MediaControl extends BorderPane {
        ...
        ImageView             imageViewPlay  = new ImageView(new Image(IMGS.class.getResourceAsStream("btn-media-play.png")));
        ImageView             imageViewPause = new ImageView(new Image(IMGS.class.getResourceAsStream("btn-media-pause.png")));
