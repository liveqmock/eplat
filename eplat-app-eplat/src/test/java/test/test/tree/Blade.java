...
public class Blade extends Path {
    ...
    private double              x            = RandomUtil.getRandom(900);                                              // width of grass ground
    private double              y            = RandomUtil.getRandom(20) + 20;                                          // height of grass ground
    private double              h            = (50 * 1.5 - y / 2) * RandomUtil.getRandom(0.3);                         // height
                                                                                                                        // of
                                                                                                                        // blade
    public SimpleDoubleProperty phase        = new SimpleDoubleProperty();                                             // phase of
                                                                                                                        // blade
                                                                                                                        // movement
    ...
    public Blade() {
        ...
        curve1.xProperty().bind(new DoubleBinding() {
            ...
            final double rand = RandomUtil.getRandom(PI / 4); // to separate
                                                              // blade
                                                              // movement
