 ...
 * 
 * @author obullxl@gmail.com
 * @version $Id: OLEExample.java, V1.0.1 2013-3-31 下午5:07:24 $
 */
    ...
    void fileOpen() {
        ...
        if (clientSite == null) {
            ...
            if (index != -1) {
                ...
                if (fileExtension.equalsIgnoreCase("doc") || fileExtension.equalsIgnoreCase("rtf") || fileExtension.equalsIgnoreCase("txt")) {
                    try {
        ...
        if (clientSite == null) {
            ...
            if (index != -1) {
                String fileExtension = fileName.substring(index + 1);
                if (fileExtension.equalsIgnoreCase("wmv") || fileExtension.equalsIgnoreCase("mpg") || fileExtension.equalsIgnoreCase("mpeg") || fileExtension.equalsIgnoreCase("avi")
                    || fileExtension.equalsIgnoreCase("asf") || fileExtension.equalsIgnoreCase("wav")) {
                    try {
