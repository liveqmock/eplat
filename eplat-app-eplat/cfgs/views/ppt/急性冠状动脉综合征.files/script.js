...
var ENDSHOW_MESG="放映结束，单击鼠标退出。", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=45, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gMainDoc=new Array(new hrefList("slide0003.htm",1,-1,1),new hrefList("slide0006.htm",1,-1,1),new hrefList("slide0052.htm",1,-1,1),new hrefList("slide0007.htm",1,-1,1),new hrefList("slide0008.htm",1,-1,1),new hrefList("slide0009.htm",1,-1,1),new hrefList("slide0010.htm",1,-1,1),new hrefList("slide0011.htm",1,-1,1),new hrefList("slide0012.htm",1,-1,1),new hrefList("slide0013.htm",1,-1,1),new hrefList("slide0014.htm",1,-1,1),new hrefList("slide0015.htm",1,-1,1),new hrefList("slide0016.htm",1,-1,1),new hrefList("slide0017.htm",1,-1,1),new hrefList("slide0018.htm",1,-1,1),new hrefList("slide0019.htm",1,-1,1),new hrefList("slide0020.htm",1,-1,1),new hrefList("slide0021.htm",1,-1,1),new hrefList("slide0038.htm",1,-1,1),new hrefList("slide0022.htm",1,-1,1),new hrefList("slide0023.htm",1,-1,1),new hrefList("slide0024.htm",1,-1,1),new hrefList("slide0025.htm",1,-1,1),new hrefList("slide0026.htm",1,-1,1),new hrefList("slide0027.htm",1,-1,1),new hrefList("slide0028.htm",1,-1,1),new hrefList("slide0029.htm",1,-1,1),new hrefList("slide0030.htm",1,-1,1),new hrefList("slide0036.htm",1,-1,1),new hrefList("slide0037.htm",1,-1,1),new hrefList("slide0033.htm",1,-1,1),new hrefList("slide0034.htm",1,-1,1),new hrefList("slide0065.htm",1,-1,1),new hrefList("slide0053.htm",1,-1,1),new hrefList("slide0054.htm",1,-1,1),new hrefList("slide0055.htm",1,-1,1),new hrefList("slide0056.htm",1,-1,1),new hrefList("slide0057.htm",1,-1,1),new hrefList("slide0058.htm",1,-1,1),new hrefList("slide0059.htm",1,-1,1),new hrefList("slide0060.htm",1,-1,1),new hrefList("slide0061.htm",1,-1,1),new hrefList("slide0062.htm",1,-1,1),new hrefList("slide0063.htm",1,-1,1),new hrefList("slide0064.htm",1,-1,1));
...
{
	external.CW_GoToSldNumMess(num );
...
function EndShow()
{
	...
	if( dir != "rtl" ) dir = "ltr";
	doc.open()
	doc.writeln('<html><body dir=' + dir + ' bgcolor=black onload=external.CW_CloseFullScreenMess() onunload=parent.Unload()><center><p><font face=Tahoma color=white size=2><br><b>' + ENDSHOW_MESG + '</b></font></p></center></body></html>')
	doc.close()
}
...
function SkipToSldNum( num )
{
	GoToSld( GetHrefObj(num).mSldHref )
}